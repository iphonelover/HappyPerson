...
- (void)addInfiniteScrollingWithActionHandler:(void (^)(void))actionHandler {
    ...
    if(!self.infiniteScrollingView) {
        SVInfiniteScrollingView *view = [[SVInfiniteScrollingView alloc] initWithFrame:CGRectMake(0, (self.contentSize.height ? self.contentSize.height : kApplecationScreenHeight), self.bounds.size.width, SVInfiniteScrollingViewHeight)];
