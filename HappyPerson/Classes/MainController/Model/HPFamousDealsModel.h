...
@interface HPFamousDealsModel : NSObject
...
@property (nonatomic, strong) NSNumber *dealsID;
@property (nonatomic, strong) NSString *title;
@property (nonatomic, strong) NSNumber *discountShowType;
