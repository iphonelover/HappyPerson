//
//  HPPerformanceCollectionCellTwo.m
//  HappyPerson
//
...
@interface HPPerformanceCollectionCellTwo ()
...
@implementation HPPerformanceCollectionCellTwo
...
-(void)cellLayout
{
    ...
    [_imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_detail.mas_right).with.offset(10);
        make.top.equalTo(ws).with.offset(10);
